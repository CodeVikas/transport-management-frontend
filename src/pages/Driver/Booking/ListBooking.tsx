...
import { Search, ChevronLeft, ChevronRight, BadgePlus } from "lucide-react";
...
export default function BookingListPage() {
  ...
  const { bookings, statusBookings } = useSelector((state) => state.bookings);
  ...
  const handleConfirmAddToTrip = async (booking) => {
    setIsModalOpen(false);
    setSelectedBooking(null);
    await dispatch(makeMyTrip({ id: booking?._id })).then((res) => {
  ...
  }, [dispatch, statusBookings, currentPage, bookingsPerPage, searchTerm]); // Add searchTerm to dependencies
  ...
  `}
                      ...
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-4">
                          <Tooltip content="Add to My Trip">
                            <button
